...
// grava a porta INTERNA do Vite (5173) pra reconectar o WebSocket. Atras do
// proxy reverso Apache (179.105.102.53:9444 -> 172.17.163.183:5173), a 5173
// nao esta liberada externamente - so a 9444 - entao o socket de HMR falha e
// fica retentando em loop (sintoma: pagina carrega, conexao "oscila" depois).
// So ativa quando VITE_HMR_CLIENT_PORT esta definida, pra nao quebrar acesso
// direto (ex: dev local em http://172.17.163.183:5173 sem passar pelo proxy).
